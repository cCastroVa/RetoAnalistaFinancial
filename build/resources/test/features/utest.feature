...
Feature: Join the community of testers.
  ...
  Scenario: Register on the Utest.com page
    ...
    And he enters the data required in the four registration steps
      | first_name | last_name | email_address     | month_bird | day_bird | year_bird | language | city             | postal_code | country  | computer | version              | language_computer   | mobile_device | model        | operating_system | password       | repeat_password   |
      | Carlos     | Castro    | castro@correo.com | December   | 3        | 1997      | Spanish  | Bello, Antioquia | 050044      | Colombia | Windows  | Windows 10 Education | Spanish             | Motorola      | Moto G9 Plus | Android 10       | Asdfghjkl123*a | Asdfghjkl123*a    |
