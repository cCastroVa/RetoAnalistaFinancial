...
public class DataRequired {
    ...
    public String getDay_bird() {
        return day_bird;
    }
    public void setDay_bird(String day_bird) {
        this.day_bird = day_bird;
    }

    public String getYear_bird() {
        return year_bird;
    }
    ...
    public String getLanguage_computer() {
        return language_computer;
    }
    public void setLanguage_computer(String language_computer) {
